...
from kks.util.ejudge import EjudgeSession, RunField
from kks.ejudge_priv import ejudge_submissions


def new_submissions(
        session: EjudgeSession,
        last_run_id: t.Optional[int],
        fields_mask: RunField = RunField.DEFAULT
):
    ...
    return ejudge_submissions(session, f'id > {last_run_id}', 0, -1, fields_mask)
